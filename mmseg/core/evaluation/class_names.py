...
def shift_classes():
    """Shift class names for external use."""
    return  ['building', 'fence', 'pedestrian', 'pole', 'road line', 'road', 
...
def shift_palette():
    """Shift palette for external use."""
    PALETTE = [ [ 70, 70, 70], [100, 40, 40], [ 55, 90, 80], [220, 20, 60], 
